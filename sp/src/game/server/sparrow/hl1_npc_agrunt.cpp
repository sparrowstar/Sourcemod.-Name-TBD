...
LINK_ENTITY_TO_CLASS( npc_alien_grunt, CNPC_AlienGrunt );
...
int CNPC_AlienGrunt::IRelationPriority( CBaseEntity *pTarget )
{
	...
	{
		if (FClassnameIs(pTarget, "npc_human_grunt") || FClassnameIs(pTarget, "npc_combine_s")||FClassnameIs(pTarget, "npc_metropolice"))
		{
...
//=========================================================
AI_BEGIN_CUSTOM_NPC( npc_alien_grunt, CNPC_AlienGrunt )
