...
ConVar sk_ichthyosaurhl_health ( "sk_ichthyosaurhl_health", "0" );
...
LINK_ENTITY_TO_CLASS( npc_ichthyosaurhl, CNPC_HLIchthyosaur );

BEGIN_DATADESC( CNPC_HLIchthyosaur )
...
AI_BEGIN_CUSTOM_NPC( npc_ichthyosaurhl, CNPC_HLIchthyosaur )
...
//=========================================================
void CNPC_HLIchthyosaur::Precache()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_HLIchthyosaur::Spawn( void )
{
	Precache( );
	...
	m_iHealth			= sk_ichthyosaurhl_health.GetFloat();
	...
	SetTouch( &CNPC_HLIchthyosaur::BiteTouch );
...
//=========================================================
//=========================================================
int CNPC_HLIchthyosaur::TranslateSchedule( int scheduleType )
{
	switch	( scheduleType )
	{
...
int CNPC_HLIchthyosaur::SelectSchedule()
{
	switch(m_NPCState)
	{
	case NPC_STATE_IDLE:
...
bool CNPC_HLIchthyosaur::OverrideMove( float flInterval )
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CNPC_HLIchthyosaur::MoveExecute_Alive(float flInterval)
{
...
void CNPC_HLIchthyosaur::InputStartCombat( inputdata_t &input )
{
	m_bOnAttack = true;
}

void CNPC_HLIchthyosaur::InputEndCombat( inputdata_t &input )
{
	m_bOnAttack = false;
}
...
// schedule.
//=========================================================
void CNPC_HLIchthyosaur::StartTask(const Task_t *pTask)
{
	switch (pTask->iTask)
	{
...
void CNPC_HLIchthyosaur::RunTask(const Task_t *pTask )
{
...
// Output : int
//-----------------------------------------------------------------------------
int CNPC_HLIchthyosaur::MeleeAttack1Conditions( float flDot, float flDist )
{
...
//=========================================================
int CNPC_HLIchthyosaur::RangeAttack1Conditions( float flDot, float flDist )
{
...
void CNPC_HLIchthyosaur::BiteTouch( CBaseEntity *pOther )
{
...
//=========================================================
void CNPC_HLIchthyosaur::HandleAnimEvent( animevent_t *pEvent )
{
...
// relationship table.
//=========================================================
Class_T CNPC_HLIchthyosaur::Classify ( void )
{
	return	CLASS_ALIEN_MONSTER;
}

void CNPC_HLIchthyosaur::NPCThink ( void )
{
	// blink the eye
...
//-----------------------------------------------------------------------------
float CNPC_HLIchthyosaur::GetGroundSpeed( void )
{
	if ( GetIdealActivity() == ACT_GLIDE )
...
Vector CNPC_HLIchthyosaur::DoProbe( const Vector &Probe )
{
...
bool CNPC_HLIchthyosaur::ProbeZ( const Vector &position, const Vector &probe, float *pFraction)
{
...
//-----------------------------------------------------------------------------
bool CNPC_HLIchthyosaur::FVisible( CBaseEntity *pEntity, int traceMask, CBaseEntity **ppBlocker )
{
...
void CNPC_HLIchthyosaur::IdleSound( void )	
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Idle" );
}

void CNPC_HLIchthyosaur::AlertSound( void ) 
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Alert" );
}

void CNPC_HLIchthyosaur::AttackSound( void ) 
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Attack" );
}

void CNPC_HLIchthyosaur::BiteSound( void ) 
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Bite" );
}

void CNPC_HLIchthyosaur::DeathSound( const CTakeDamageInfo &info ) 
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Die" );
}

void CNPC_HLIchthyosaur::PainSound( const CTakeDamageInfo &info )	
{ 
	CPASAttenuationFilter filter( this );
...
//-----------------------------------------------------------------------------
void CNPC_HLIchthyosaur::GatherEnemyConditions( CBaseEntity *pEnemy )
{
	// Do the base class
